...
export default function NameBadgePage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center flex-col gap-5">
      ...
      <a href="https://snack.expo.dev/@jx1126/week-7---food-app?platform=android" target="_blank" rel="noopener noreferrer">
        <SplitText
      ...
      <div
        ...
        data-snack-id="@jx1126/week-7---food-app"
